...
def is_rotated_string(s1, s2):
    ...
    Assuming the string is rotated, it can be thought as being split in this
    way: s1 = part1 + part2 and s2 = part2 + part1. We can notice that
    s2 + s2 = part2 + part1 + part2 + part1 = part2 + s1 + part1
